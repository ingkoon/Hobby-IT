...
<template>
  <v-card class="bg mx-auto" style="height: 500px; background-color: #0e0f28; color: white" width="600">
              ...
              <v-row>
                <v-item v-slot="{ isSelected, toggle }">
                  ...
                  >
                    ...
                    >
                      자유 가입<br /><v-divider style="margin: 5px"></v-divider
                ...
                <v-item v-slot="{ isSelected, toggle }">
                  ...
                  >
                    ...
                    <div
                      ...
                      style="color: white; font-size: 20px; font-weight: 700"
                    >
                      신청 가입<br /><v-divider style="margin: 5px"></v-divider
                      ><span style="font-size: 12px; font-weight: 400"
    ...
    <v-card-actions>
      ...
      <v-btn v-if="step == 3" color="white" icon="mdi-check" size="48" style="background-color: #fa8eb6"> </v-btn>
    </v-card-actions>
  </v-card>
</template>
