<template>
  <v-card id="delgroup">
    ...
    <v-icon icon="mdi-close-circle" style="align-self:center"></v-icon>
    <div style="font-size:36px">모임을 삭제하시겠습니까?</div>
    <div style="font-size:14px; font-family:linefont">삭제한 모임은 복구가 불가능합니다.</div>
