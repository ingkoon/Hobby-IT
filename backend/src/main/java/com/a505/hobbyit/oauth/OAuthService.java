...
//            sb.append("&redirect_uri=" + redirect_uri);
            sb.append("&client_id=65d9de3ecb31d4f1a02eb1e2affe862f"); // TODO REST_API_KEY 입력
            sb.append("&redirect_uri=http://localhost:8090/api/oauth/kakao"); // TODO 인가코드 받은 redirect_uri 입력
            sb.append("&code=" + code);
    ...
    public void createKakaoUser(String token) {
        ...
        try {
            ...
            boolean hasEmail = element.getAsJsonObject().get("kakao_account").getAsJsonObject()
                    .get("email_needs_agreement").getAsBoolean();
            String email = id;
            if (!hasEmail) {
